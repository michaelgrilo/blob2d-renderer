...
## High Concept
**Beyond vs Below** is a **1v1v1 Capture-the-Flag tactics game**.  
Two players (Aliens vs Demons) compete while a third, non-playable faction — **Humans** — acts as a **Living Chaos Engine** that escalates over time and can **win the match itself**.

The game is deterministic, positional, and pressure-driven: every match escalates toward a forced conclusion.

---

## Factions

### 👽 Aliens (Beyond) — Playable
...
- **👩 Karens:** Zerg-style swarm, scream debuffs, overwhelm by numbers
- **Bosses:**  
  - Mega Karen  
  - Bro Titan  
  - Boomer Horde
...
- **Pull:**  
  - No damage  
  - Setup tool for later push
- **Charged Push:**  
  - Spend secondary action  
  - Next turn pushes 2 cells
- **Interactions:**  
...
### Turn Timer & Defaults
- If a player times out, units perform a **default action**
  - Move, push, attack, or defend
